...
def maybe_enable_profiling(config: TrainJobConfig, *, global_step: int = 0):
    # get user defined profiler settings
    enable_profiling = config.profiling.enable_profiling

    if enable_profiling:
        dump_dir = config.training.dump_folder
...
@contextlib.contextmanager
def maybe_enable_memory_snapshot(config: TrainJobConfig, *, global_step: int = 0):
